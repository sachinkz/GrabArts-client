...
export const InviteModal = () => {
    ...
    const {server}=data;
    const inviteUrl=`${origin}/messaging/invite/${server?.inviteCode}`
        ...
        <Dialog open={isModalOpen} onOpenChange={onClose}>
            <DialogContent className="bg-white text-black p-0 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    <Button onClick={generateInviteCode} disabled={isLoading} variant="link" size='sm' className="text-xs text-zinc-500 mt-4">
                        Generate a new link
